          ...
          if (fs.existsSync(requestsDir)) {
            ...
            for (const file of requestFiles) {
              ...
              try {
                ...
                // 获取飞书 Channel
                const feishuChannel = deps.getFeishuChannel?.();
                if (!feishuChannel) {
                  throw new Error('Feishu channel not available');
                }
                ...
                switch (request.type) {
                  ...
                  // 多维表格操作
                  case 'create_bitable':
                    result = await feishuChannel.createBitableApp(request.name);
                    break;
                  case 'create_bitable_table':
                    result = await feishuChannel.createBitableTable(
                      request.app_token,
                      request.name,
                      request.fields,
                    );
                  ...
                  case 'send_file':
                    ...
                    logger.debug(
                      {
                        containerPath: request.file_path,
                  ...
                  case 'approval_get_instance': {
                    ...
                    if (
                      ...
                      logger.warn(
                        { sourceGroup, action: 'get_instance' },
                        'Approval action denied',
                      );
                      throw new Error(
                        `approval action 'get_instance' not allowed for group '${sourceGroup}'`,
                      );
                    }
                      ...
                      logger.warn(
                        {
                          sourceGroup,
                          action: 'approve',
                          approvalCode: request.params?.approval_code,
                        },
                        'Approval action denied',
                      );
                      throw new Error(
                        `approval action 'approve' not allowed for group '${sourceGroup}'`,
                      );
                    }
                  ...
                  case 'approval_reject': {
                    ...
                    if (
                      ...
                      throw new Error(
                        `approval action 'reject' not allowed for group '${sourceGroup}'`,
                      );
                    }
                  ...
                  case 'approval_transfer': {
                    ...
                    if (
                      ...
                      throw new Error(
                        `approval action 'transfer' not allowed for group '${sourceGroup}'`,
                      );
                    }
                  ...
                  case 'approval_comment': {
                    const approvalCfg = loadApprovalAllowlist();
                    if (
                      !isApprovalAllowed(approvalCfg, sourceGroup, 'comment')
                    ) {
                      logger.warn(
                        { sourceGroup, action: 'comment' },
                        'Approval action denied',
                      );
                      throw new Error(
                        `approval action 'comment' not allowed for group '${sourceGroup}'`,
                      );
                    }
                    // 自动注入 Bot open_id
                  ...
                  case 'approval_query': {
                    ...
                    if (
                      ...
                      throw new Error(
                        `approval action 'query' not allowed for group '${sourceGroup}'`,
                      );
                    }
                ...
                logger.debug(
                  { type: request.type, file, sourceGroup },
                  'Feishu IPC request processed',
                );
              } catch (err) {
                logger.error(
                  { file, err, sourceGroup },
